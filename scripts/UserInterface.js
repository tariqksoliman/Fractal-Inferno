function UserInterface( fractalinferno ) {
    ...
    var rightpanel = $( '#rightpanel' );
        ...
        .attr( 'class', 'active' )
        .text( 'Random' );
        rightpanel.append( randomDiv );

        var customDiv = $( '<div/>' )
        .attr( 'id', 'customDiv' )
        .text( 'Custom' );
        rightpanel.append( customDiv );

        var rfunctionsDiv = $( '<div/>' )
            .attr( 'id', 'rfunctionsDiv' )
            .attr( 'class', 'scrollbar' );
        rightpanel.append( rfunctionsDiv );
        ...
        var functionsDiv = $( '<div/>' )
            .attr( 'id', 'functions' )
            .attr( 'class', 'scrollbar' );
        rightpanel.append( functionsDiv );
        ...
        var preIterateDiv = $( '<div/>' )
            .attr( 'id', 'preIterate' );
        rightpanel.append( preIterateDiv );
        ...
        var beforeNewDiv = $( '<div/>' )
            .attr( 'id', 'beforeNew' );
        rightpanel.append( beforeNewDiv );
    ...
    var leftpanel = $( '#leftpanel' )
        ...
        var continueButton = $( '<div/>' )
            ...
            .text( 'Continue' );
        leftpanel.append( continueButton );
